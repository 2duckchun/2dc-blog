...
interface ProblemSolvingPostPageProps {
  params: Promise<{ slug: string[] }>
}

const CONTENT_PATH_LIST = ['problem-solving']

const ProblemSolvingPostPage = async ({
  params
}: ProblemSolvingPostPageProps) => {
...
export default ProblemSolvingPostPage
